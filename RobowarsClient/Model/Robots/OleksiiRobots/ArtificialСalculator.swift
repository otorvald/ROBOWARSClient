...
class ArtificialСalculator {
    ...
    let name = "Сalculator"
    let greetingMessage = "Artificial: Yes! intelligence: No!"
    let winMessage = "100% success"
    let loseMessage = "Impossible!!!"
    
    //MARK: - Private Properties
    private var fieldRect: CGRect = .zero
    private var shipsCount: Int = 0
    private var possibleShipSizes: [CGSize] = []
    private var brain: ArtificialBrain = ArtificialBrain(fieldRect: .zero, possibleShipSizes: [], count: 0)
}
